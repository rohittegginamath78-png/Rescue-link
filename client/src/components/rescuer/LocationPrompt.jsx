      ...
      <div className="card bg-gradient-to-br from-green-50 to-white">
        <div className="text-center">
          ...
          <h2 className="mb-2 text-xl font-medium text-gray-900">
            Find Rescuers Near You
          </h2>
          <p className="mb-6 text-sm text-gray-600">
            Enable location access to find verified wildlife rescuers within
            your area.
          </p>
          ...
          <p className="mt-4 text-xs text-gray-500">
            Your location is used only to find nearby rescuers. We do not store
            it.
          </p>
        </div>
      </div>
